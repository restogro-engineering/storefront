...
@Component({
    selector: "vsf-handpiece-store",
    templateUrl: "./handpiece-store.component.html",
    styleUrls: ["./handpiece-store.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class HandpieceStoreComponent implements OnInit {
